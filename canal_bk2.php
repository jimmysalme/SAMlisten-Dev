...
<!--=====================================
    ...
    ========================================-->
<div id="jSplash">
  <figure class="preload_logo"> <img src="assets/img/basic/logo2.png" alt="SAMlisten.com"/> </figure>
</div>
                  ...
                  <li class="music_row row" style="border:none;">
                    ...
                    <div id="compartir_rs" class="col-xs-12 col-md-2">
                      <table border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <td align="left"><a href="https://www.facebook.com/dialog/feed?app_id=<?php echo $app_id_fb_canal; ?>&link=<?php echo WEB_SITE."?cn=".$id_cancion; ?>&picture=<?php echo WEB_SITE."images/artistas/".$bg1_artista; ?>&name=<?php echo urlencode($titulo." - ".$artista);?>&to=&description=<?php echo urlencode($descripcion_canal." | Música online.");?>&redirect_uri=http://www.samlisten.com/close.php" target="_blank"><img src="images/facebook-like-4-64.png" width="48" height="48" alt="Compartir" /></a></td>
                          ...
                          <td align="left"><a href="
                            https://plus.google.com/share?url=<?php echo WEB_SITE."?cn=".$id_cancion; ?>&hl=es" target="_blank"><img src="images/google-plus-4-64.png" width="48" height="48" alt="Compartir" /></a></td>
                        </tr>
                      </table>
                    </div>
                    <?php /////////////Votos/////////// ?>
    ...
    <section id="section_9" class="tours_section">
      <div class="container">
        ...
        <div class="tours_widget">
          ...
          <?php
			  $qr_top = DB::query("SELECT c.titulo, c.artista, a.bg1_artista, c.votos, c.link_video, c.link_audio, c.letra
									FROM psn_canciones c
									INNER JOIN psn_artistas a ON c.artista = a.artista
									WHERE c.carpeta = 1
